...
<div class="max-w-2xl">
    ...
    <form method="POST" action="{{ route('admin.events.update', $event) }}" class="bg-gray-900 rounded-xl border border-gray-800 p-6 space-y-4">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="banner_url" value="{{ old('banner_url', $event->banner_url) }}"
                class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-green-500">
        </div>
