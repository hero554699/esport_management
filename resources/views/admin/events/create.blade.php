...
<div class="mb-6">
    <a href="{{ route('admin.events.index') }}"
        class="inline-flex items-center gap-1.5 text-gray-400 hover:text-orange-500 transition text-sm">
    ...
    <h1 class="text-2xl font-medium text-white mt-4 mb-1">Create Tournament</h1>
    <p class="text-gray-400 text-sm">Create a new tournament. These tournaments are automatically approved.</p>
</div>
...
<form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data"
    class="bg-gray-900 border border-gray-800 rounded-xl p-8 flex flex-col gap-5 max-w-2xl">
    @csrf
    ...
    <div class="flex flex-col gap-1.5">
        ...
        <input type="text" name="name" value="{{ old('name') }}"
            ...
            class="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white text-sm placeholder-gray-600 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10 focus:outline-none transition"
            required>
        @error('name')
    ...
    <div class="flex flex-col gap-1.5">
        ...
        <select name="game_id"
            class="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10 focus:outline-none transition"
            required>
    ...
    <div id="certificationSection" class="hidden flex flex-col gap-5">
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <div class="border border-dashed border-gray-600 rounded-xl p-8 text-center hover:border-orange-500 hover:bg-orange-500/[0.03] transition cursor-pointer group"
        ...
        {{-- Toggle --}}
        <div class="bg-gray-800 border border-gray-700 rounded-xl px-4 py-3.5 flex items-center justify-between gap-4">
            <div>
    ...
    <div class="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
        <p class="text-green-300 text-xs">
            <strong class="text-green-400">ℹ Admin tournaments are automatically approved</strong> — They don't require user approval.
        </p>
    </div>
