...
<head>
    ...
    <title>Edit Tournament — EsportsTrack</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-input, .form-select { width: 100%; background: rgba(255,255,255,0.04); border: 1px solid var(--border); border-radius: 8px; padding: 10px 14px; color: var(--t1); font-family: 'Inter', sans-serif; font-size: 14px; outline: none; transition: border-color 0.2s; }
